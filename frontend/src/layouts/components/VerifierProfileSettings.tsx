...
const VerifierProfileSettings: React.FC<issuerDataI> = ({ id, did, name, email, govId, walletId, trustedIssuers, setVerifierData}) => {
    ...
    const [originalIdentity, setOriginalIdentity] = useState<string | undefined>(govId);
      ...
      const PutIssuer = async () => {
        ...
        if (response.ok) {
          ...
          const verifierData = {
                id: id ? id.toString() : "",
                name: verifierName ? verifierName.toString() : "",
                email: verifierEmail ? verifierEmail.toString() : "",
    ...
    const handleSaveChanges = (e: any) => {
        e.preventDefault();
        if (verifierName === "") toast.error("Name cannot be empty!");
        else if (verifierEmail === "") toast.error("Email cannot be empty!");
    ...
    const handleCancelEdit = () => {
        setVerifierName(originalName);
        setVerifierEmail(originalEmail);
